...
*/
bool checkTel(string);//длина строки 10 символов, все из которых цифры;
...
public:
    ...
    vector<dataa> add(vector<dataa>,int,string,string,string); // Добавить в базу

    vector<dataa> del(vector<dataa>,int);//удаляем данные с заданным id

    vector<dataa> change(vector<dataa>,int,string,string,string);// меняем данные с заданным id, на заданные данные temp_data
